    ...
    <div class="intro-img-text">
        ...
        <div class="intro-text">
            ...
            <ul>
                ...
                <li><img src="{{asset('assets/img/carbon_location-filled.png')}}" /><span>abuja, nigeria</span></li>
                <li><img src="{{asset('assets/img/bx_bxs-phone-call.png')}}" /><span>+234 8099 -2221-110</span></li>
...
<div class="boxes">
    <div class="boxes-items">
        ...
        <div class="boxes-item bg-red">
            <div class="boxes-item-number">45</div>
            <div class="boxes-item-icon">
