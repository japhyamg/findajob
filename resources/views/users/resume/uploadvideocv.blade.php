...
<div class="upload-resume main-content">
    <div class="upload-resume-cont">
        ...
        <div class="upload-resume-body">
            ...
            <form method="POST" action="{{route('user.upload-video-cv')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="resume"   accept=".mp4" size="60" >
                    </label>
                    @error('resume')
                ...
                <p class="file-type">Optionally upload a CV no larger than 100MB for file types .mp4</p>
    ...
    function deletemedia(mediaid){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios({
                    method: 'delete',
                    url: '{{route('user.delete-video-cv')}}',
                    data: {
                        mediaid: mediaid
                    }
                })
