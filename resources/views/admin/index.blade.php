    ...
    <div class="intro">
        <div class="intro-img-text">
            ...
            <div class="intro-text">
                <div class="intro-text-head">zuxx nigeria limited</div>
                <ul>
                    <li><img src="{{asset('assets/img/square.png')}}" /><span>info@zuxxltd.com</span></li>
                    <li><img src="{{asset('assets/img/square.png')}}" /><span>New York, New York, United States</span></li>
                    <li><img src="{{asset('assets/img/square.png')}}" /><span>+234 8099 -2221-110</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="boxes">
        <div class="boxes-items">
            ...
            <div class="boxes-item bg-green">
                <div class="boxes-item-number">52</div>
