...
<div class="shortlisted-resume main-content">
    <div class="shortlisted-resume-head">
    ...
    <div class="search-result">
        <div class="search-result-head">
            ...
            <div class="search-result-head-form">
                <form>
                    <select>
                ...
                <table>
                    ...
                    @if ($applications)
                        @foreach ($applications as $application)
                            <tr>
                                <td>{{$application->applicant->full_name}} <br><span class="last-activity">Last Activity 04 min ago</span></td>
                                <td>lagos</td>
                                <td>7 years</td>
                                <td>{{$application->job->title}}</td>
                                <td>{{$application->created_at->diffForHumans()}}</td>
                                <td class="action-btns">
                                    <a href="#">approve</a><a href="#" class="grey-bg">Not Suitable</a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
                    {{-- <tr>
                        <td>john doe <br><span class="last-activity">Last Activity 04 min ago</span></td>
                        <td>lagos</td>
                        <td>7 years</td>
                        <td>Accountant</td>
                        <td>20-07-21</td>
